const arrHumans = [" ", 1, 1, 1, 1, 7, 11, 14, 17, 20, 28, 34, 45, 59, 63, 93, 114, 147, 199, 253, 306, 367,
    ...
    405843, 414878, 423741];
let recovered = 186985; //выздоровлений
let deaths = 5037; // смертей
let sverdlRegion = 6024;
let sverdlRegionRecovered = 2510;
let sverdlRegionDeaths = 31;
let statWorld = statFunc("world ", 5665529, 364644);
let stat1 = statFunc("usa ", 1770384, 103781);
let stat2 = statFunc("brazilian ", 498440, 28834);
let stat3 = statFunc("british ", 274219, 38458);
