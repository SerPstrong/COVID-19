const arrHumans = [" ", 1, 1, 1, 1, 7, 11, 14, 17, 20, 28, 34, 45, 59, 63, 93, 114, 147, 199, 253, 306, 367,
    ...
    493657, 502436, 511423, 520129, 528964];
const recovered = [195957, 204623, 212680, 221388, 226731, 230688, 242397, 252783,261150, 269370, 274641, 280050];
const deaths = [5971, 6141, 6358, 6532, 6715, 6829, 6948];
const sverdlRegion = [7668, 7910, 8194, 8506, 8826, 9071, 9325];
const sverdlRegionRecovered = [3273, 3495, 3642, 3790, 3912, 4021, 4144];
const sverdlRegionDeaths = [43, 46, 48, 48, 48, 50, 50];
let statWorld = statFunc("world ", 7140253, 419142);
let stat1 = statFunc("usa ", 2048986, 114669);
let stat2 = statFunc("brazilian ", 828810, 41828);
let stat3 = statFunc("india ", 308916, 8884);
