...
let recovered = 167469; //выздоровлений
let deaths = 4555; // смертей
let sverdlRegion = 5184;
let sverdlRegionRecovered = 2142;
let sverdlRegionDeaths = 26;
let statWorld = statFunc("world ", 5541013, 360605);
let stat1 = statFunc("usa ", 1747087, 102836);
let stat2 = statFunc("brazilian ", 465166, 27878);
let stat3 = statFunc("british ", 272607, 38243);
