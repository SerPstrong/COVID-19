const arrHumans = [" ", 1, 1, 1, 1, 7, 11, 14, 17, 20, 28, 34, 45, 59, 63, 93, 114, 147, 199, 253, 306, 367,
    ...
    106498, 114431];
let recovered = 13220; //выздоровлений
let deaths = 1169; // смертей
let sverdlRegion = 935;
let sverdlRegionRecovered = 102;
let sverdlRegionDeaths = 1;
let statWorld = statFunc(3095261, 226716);
let statUSA = statFunc(1040488, 60999);
let statItaly = statFunc(203591, 27682);
