const arrHumans = [" ", 1, 1, 1, 1, 7, 11, 14, 17, 20, 28, 34, 45, 59, 63, 93, 114, 147, 199, 253, 306, 367,
    ...
    8672, 10131, 11917, 13584, 15770, 18328, 21102, 24490, 27938, 31989, 36793, 42853, 47121, 52763];
let recovered = 3873; //выздоровлений
let deaths = 456; // смертей
let sverdlRegion = 233;
let sverdlRegionRecovered = 55;
let sverdlRegionDeaths = 1;
let statWorld = statFunc(2406745, 165273);
let statUSA = statFunc(759766, 40683);
let statItaly = statFunc(178972, 23660);
