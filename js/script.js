const arrHumans = [" ", 1, 1, 1, 1, 7, 11, 14, 17, 20, 28, 34, 45, 59, 63, 93, 114, 147, 199, 253, 306, 367,
    ...
    8672, 10131, 11917, 13584, 15770, 18328, 21102, 24490, 27938, 31989, 36793, 42853, 47121, 52763, 57999];
let recovered = 4420; //выздоровлений
let deaths = 513; // смертей
let sverdlRegion = 243;
let sverdlRegionRecovered = 60;
let sverdlRegionDeaths = 1;
let statWorld = statFunc(2511308, 177026);
let statUSA = statFunc(825306, 45075);
let statItaly = statFunc(183957, 24648);
