...
let statWorld = statFunc("world ", 7495723, 429779);
let stat1 = statFunc("usa ", 2114026, 116127);
let stat2 = statFunc("brazilian ", 888271, 43959);
let stat3 = statFunc("india ", 343091, 9900);
