const arrHumans = [" ", 1, 1, 1, 1, 7, 11, 14, 17, 20, 28, 34, 45, 59, 63, 93, 114, 147, 199, 253, 306, 367,
    ...
    106498, 114431, 124054, 134687, 145268, 155370, 165929, 177160, 187859];
let recovered = 31916; //выздоровлений
let deaths = 1827; // смертей
let sverdlRegion = 1705;
let sverdlRegionRecovered = 269;
let sverdlRegionDeaths = 3;
let statWorld = statFunc(3750832, 273190);
let statUSA = statFunc(1283929, 77180);
let statSpain = statFunc(222857, 26299);
let statItaly = statFunc(217185, 30201);
