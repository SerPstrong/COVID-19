...
let statWorld = statFunc("world ", 4599291, 320523);
let stat1 = statFunc("usa ", 1528661, 91938);
let stat2 = statFunc("brazilian ", 271885, 17983);
let stat3 = statFunc("british ", 250138, 35422);
