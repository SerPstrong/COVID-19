const arrHumans = [" ", 1, 1, 1, 1, 7, 11, 14, 17, 20, 28, 34, 45, 59, 63, 93, 114, 147, 199, 253, 306, 367,
    ...
    8672, 10131, 11917, 13584, 15770, 18328, 21102, 24490, 27938];
let recovered = 2304; //выздоровлений
let deaths = 232; // смертей
let sverdlRegion = 111;
let sverdlRegionRecovered = 44;
